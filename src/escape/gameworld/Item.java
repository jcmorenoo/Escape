	...
	private void drawItem(Graphics g, Item i, Direction d) {
		...
		case "Bed":
			...
			case EAST:
				...
				g.setColor(Color.RED);
				g.drawRect(scaleImgPos(40), scaleImgPos(260), scaleImgWidth(bed), scaleImgHeight(bed));
				break;
			}
			break;
		...
		case "Bedroom Lamp":
			...
			case NORTH:
				...
				g.setColor(Color.RED);
				g.drawRect(scaleImgPos(490), scaleImgPos(120), scaleImgWidth(bedroomLamp), scaleImgHeight(bedroomLamp));
		...
		case "Chair":
			...
			case EAST:
				...
				boundingBox(scaleImgPos(100), scaleImgPos(220), scaleImgWidth(chairSide), scaleImgHeight(chairSide));
		...
		case "Kitchen Picture":
			...
			case EAST:
				...
				g.setColor(Color.RED);
				g.drawRect(scaleImgPos(490), scaleImgPos(370),
			...
			case SOUTH:
				...
				boundingBox(scaleImgPos(100), scaleImgPos(370), scaleImgWidth(kitchenPicture),
						scaleImgHeight(kitchenPicture));
				g.setColor(Color.RED);
				g.drawRect(scaleImgPos(100), scaleImgPos(370),
						scaleImgWidth(kitchenPicture), scaleImgHeight(kitchenPicture));
				break;
			}
			break;
		...
		case "Study Door":
			...
			case SOUTH:
				...
				boundingBox(scaleImgPos(239), scaleImgPos(95), scaleImgWidth(studyDoor), scaleImgHeight(studyDoor));
